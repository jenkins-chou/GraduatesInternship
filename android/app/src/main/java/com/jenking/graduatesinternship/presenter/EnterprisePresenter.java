...
public class EnterprisePresenter {
    ...
    //带参基本请求方法
    public void getEnterpriseById(Map<String,String> params){
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getEnterpriseById(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.getEnterpriseById(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public interface OnCallBack{
        void getEnterpriseById(boolean isSuccess, Object object);
    }
