...
public class RecruitDeliveryModel extends BaseTableModel {

    public static final String DELIVERY_STATUS_INIT = "0";
    public static final String DELIVERY_STATUS_INTERVIEW = "1";
    public static final String DELIVERY_STATUS_UNPASS = "2";
    public static final String DELIVERY_STATUS_PASS = "3";
    public static final String DELIVERY_STATUS_INTERNSHIP = "4";
    public static final String DELIVERY_STATUS_END = "5";
    public static final String DELIVERY_STATUS_CANCEL = "6";

    private String user_id;
    private String resume_id;
    private String recruit_id;
    private String status;//投递状态（0：待审核，1：待面试，2：不通过，3：通过，4：实习中,5：实习结束，6：因其他原因注销
