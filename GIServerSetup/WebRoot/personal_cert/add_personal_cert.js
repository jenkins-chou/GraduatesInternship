		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/personal_cert/updatePersonalCert";
						else
							url=ctxPath+"/personal_cert/addPersonalCert";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/personal_cert/getPersonalCertById","id="+id,function(jsondata){
