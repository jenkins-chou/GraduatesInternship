...
var loadList = function(first) {layui.config({base : "js/"}).use([ 'form', 'layer', 'jquery', 'laypage', 'table' , 'upload'],
					function() {
						...
						table.render({
							elem : '#list',
							url : ctxPath + '/resume/getAllResume' // 数据接口
							,
							cols : [ [ // 表头
							{
								type : 'checkbox',
								...
								field : 'resume_expected_salary',
								title : '期待月薪'
							}
							,{
								field : 'resume_work_life',
								title : '工作年限'
							}
							,{
								field : 'resume_education',
								title : '教育程度'
							}
							,{
								field : 'resume_age',
							...
							,{
								field : 'resume_address',
								title : '常住地址'
							}
							,{
								field : 'resume_intention_job',
								title : '期望岗位'
							}
							,{
								field : 'resume_status',
						...
						table.on('tool(listtable)', function(obj) {
							...
							if (obj.event === 'del') {
								layer.confirm('你确认删除这条数据吗?', function(index) {
									$.getJSON(ctxPath + "/resume/deleteResume",
								...
								layer.open({
									...
									move : true,
									content : [
											ctxPath + '/resume/showHtmlModify?id='
													+ data.id, 'yes' ],
									end : function() {
									}
								});
						...
						var $ = layui.$, active = {
								...
								index = layer.open({
									...
									type : 2,
									area : [ '100%', '100%' ],
									content : ctxPath + "/resume/showHtmlAdd"
								});
							},
							reload : function() {
								var that = this;
