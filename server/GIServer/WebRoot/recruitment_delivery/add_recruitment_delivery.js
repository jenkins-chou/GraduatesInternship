		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/recruitment_delivery/updateRecruitmentDelivery";
						else
							url=ctxPath+"/recruitment_delivery/addRecruitmentDelivery";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/recruitment_delivery/getRecruitmentDeliveryById","id="+id,function(jsondata){
