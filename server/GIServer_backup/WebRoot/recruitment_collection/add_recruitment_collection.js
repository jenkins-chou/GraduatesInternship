		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/recruitment_collection/updateRecruitmentCollection";
						else
							url=ctxPath+"/recruitment_collection/addRecruitmentCollection";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/recruitment_collection/getRecruitmentCollectionById","id="+id,function(jsondata){
