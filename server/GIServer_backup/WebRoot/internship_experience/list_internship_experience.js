...
var loadList = function(first) {layui.config({base : "js/"}).use([ 'form', 'layer', 'jquery', 'laypage', 'table' , 'upload'],
					function() {
						...
						table.render({
							elem : '#list',
							url : ctxPath + '/internship_experience/getAllInternshipExperience' // 数据接口
							,
							cols : [ [ // 表头
							{
								type : 'checkbox',
								...
								field : 'internship_start_time',
								title : '实习开始时间'
							}
							,{
								field : 'internship_end_time',
								title : '实习结束时间'
							}
							,{
								field : 'internship_enterprise',
								title : '实习企业'
							}
							,{
								field : 'internship_department',
								title : '部门'
							}
							,{
								field : 'internship_job',
								title : '工作岗位'
							}
							,{
								field : 'internship_job_content',
								title : '工作内容'
							}
							,{
								field : 'internship_result',
								title : '实习结果'
							}
							,{
								field : 'internship_harvest',
								title : '实习收获'
							}
							,{
								field : 'remark',
						...
						table.on('tool(listtable)', function(obj) {
							...
							if (obj.event === 'del') {
								layer.confirm('你确认删除这条数据吗?', function(index) {
									$.getJSON(ctxPath + "/internship_experience/deleteInternshipExperience",
								...
								layer.open({
									...
									move : true,
									content : [
											ctxPath + '/internship_experience/showHtmlModify?id='
													+ data.id, 'yes' ],
									end : function() {
									}
								});
						...
						var $ = layui.$, active = {
								...
								index = layer.open({
									...
									type : 2,
									area : [ '100%', '100%' ],
									content : ctxPath + "/internship_experience/showHtmlAdd"
								});
							},
							reload : function() {
								var that = this;
									...
									layer
											.confirm(
													...
													function(index) {
														$.getJSON(
																		ctxPath
																				+ "/internship_experience/deleteSelectInternshipExperience",
																		idDatas,
																		function(
																				jsondata) {
																			if (jsondata.code == '200') {
