...
var loadList = function(first) {layui.config({base : "js/"}).use([ 'form', 'layer', 'jquery', 'laypage', 'table' , 'upload'],
					function() {
						...
						table.render({
							elem : '#list',
							url : ctxPath + '/enterprise/getAllEnterprise' // 数据接口
							,
							cols : [ [ // 表头
							{
								type : 'checkbox',
							...
							,{
								field : 'enterprise_build_time',
								title : '注册时间'
							}
							,{
								field : 'enterprise_abstract',
								title : '企业简介'
							}
							,{
								field : 'enterprise_detail',
								title : '详细介绍'
							}
							,{
							...
							,{
								field : 'enterprise_business',
								title : '业务介绍'
							}
							,{
								field : 'enterprise_leader',
								title : '企业法人'
							}
							,{
						...
						table.on('tool(listtable)', function(obj) {
							...
							if (obj.event === 'del') {
								layer.confirm('你确认删除这条数据吗?', function(index) {
									$.getJSON(ctxPath + "/enterprise/deleteEnterprise",
								...
								layer.open({
									...
									move : true,
									content : [
											ctxPath + '/enterprise/showHtmlModify?id='
													+ data.id, 'yes' ],
									end : function() {
									}
								});
						...
						var $ = layui.$, active = {
								...
								index = layer.open({
									...
									type : 2,
									area : [ '100%', '100%' ],
									content : ctxPath + "/enterprise/showHtmlAdd"
								});
							},
							reload : function() {
								var that = this;
									...
									layer
											.confirm(
													...
													function(index) {
														$.getJSON(
																		ctxPath
																				+ "/enterprise/deleteSelectEnterprise",
																		idDatas,
																		function(
																				jsondata) {
																			if (jsondata.code == '200') {
