		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/education_experience/updateEducationExperience";
						else
							url=ctxPath+"/education_experience/addEducationExperience";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/education_experience/getEducationExperienceById","id="+id,function(jsondata){
