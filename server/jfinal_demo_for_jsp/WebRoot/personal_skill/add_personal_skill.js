		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/personal_skill/updatePersonalSkill";
						else
							url=ctxPath+"/personal_skill/addPersonalSkill";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/personal_skill/getPersonalSkillById","id="+id,function(jsondata){
