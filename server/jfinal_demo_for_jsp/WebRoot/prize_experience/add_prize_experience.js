		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/prize_experience/updatePrizeExperience";
						else
							url=ctxPath+"/prize_experience/addPrizeExperience";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/prize_experience/getPrizeExperienceById","id="+id,function(jsondata){
