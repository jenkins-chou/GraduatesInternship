		...
		.use(
				...
				function() {
					...
					form.on('submit(add_know_comprehensive)', function(data) {
						...
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/internship_experience/updateInternshipExperience";
						else
							url=ctxPath+"/internship_experience/addInternshipExperience";
...
//											alert(300)
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/internship_experience/getInternshipExperienceById","id="+id,function(jsondata){
